    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="feature-card bg-white p-8 rounded-lg shadow-md flex flex-col text-center transition-all duration-700 ease-out">
                <div class="flex-grow">
                    <div class="flex justify-center mb-5"><div class="text-red-800"><svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg></div></div>
            ...
            <div class="feature-card bg-white p-8 rounded-lg shadow-md flex flex-col text-center transition-all duration-700 ease-out delay-200">
                <div class="flex-grow">
                    <div class="flex justify-center mb-5"><div class="text-red-800"><svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div></div>
            ...
            <div class="feature-card bg-white p-8 rounded-lg shadow-md flex flex-col text-center transition-all duration-700 ease-out delay-400">
                <div class="flex-grow">
                    <div class="flex justify-center mb-5"><div class="text-red-800"><svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg></div></div>
