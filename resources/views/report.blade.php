    ...
    <div class="bg-slate-50 min-h-screen flex items-center">
        ...
        <div class="container mx-auto py-16 px-4">
            ...
            <div class="text-center mb-12">
                ...
                <p class="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Apakah Anda kehilangan sesuatu atau menemukan barang
                    milik orang lain? Pilih salah satu opsi di bawah ini untuk melanjutkan.</p>
            </div>
            ...
            <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center text-center transform hover:-translate-y-2 transition-transform duration-300">

                    {{-- Wrapper Ikon. bg-red-100: Background merah muda. p-4: Padding. rounded-full: Bentuk lingkaran. mb-5: Margin bawah. --}}
                    <div class="bg-yellow-100 p-4 rounded-full mb-5">
                        {{-- SVG Icon Laporan Hilang. w-10 h-10: Ukuran 2.5rem. text-red-800: Warna merah tua. --}}
                        <svg class="w-10 h-10 text-red-800" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <p class="text-gray-600 mb-6 flex-grow">Buat laporan untuk barang Anda yang hilang agar dapat segera
                        ditemukan oleh komunitas.</p>
                    ...
                    <a href="{{ route('lost-items.create') }}"
                        class="bg-yellow-500 text-white font-bold py-3 px-10 rounded-full hover:bg-yellow-700 transition duration-300 w-full">
                        Lapor Kehilangan
                    </a>
                </div>
                ...
                <div
                    ...
                    <div class="bg-green-200 p-4 rounded-full mb-5">
                        {{-- SVG Icon Penemuan. text-gray-800: Abu gelap (untuk ikon). --}}
                        <svg class="w-10 h-10 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            {{-- Path Icon --}}
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    {{-- Deskripsi Card. --}}
                    <p class="text-gray-600 mb-6 flex-grow">Bantu orang lain dengan melaporkan barang yang Anda temukan.
                        Kebaikan kecil Anda sangat berarti.</p>

                    {{-- Tombol Aksi. bg-gray-800: Abu gelap (Hitam soft). hover:bg-gray-900: Hitam pekat saat hover. --}}
                    <a href="{{ route('found-items.create') }}"
                        class="bg-green-500 text-white font-bold py-3 px-10 rounded-full hover:bg-green-700 transition duration-300 w-full">
                        Lapor Penemuan
                    </a>
                </div>
